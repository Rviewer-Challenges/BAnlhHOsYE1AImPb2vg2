...
const styles = StyleSheet.create({
	...
	content: { paddingTop: Constants.statusBarHeight, paddingRight: 10, paddingLeft: 10 },
	sectionTitle: {
		fontSize: 20,
	},
	controlTitle: {
		...
		<View style={styles.container}>
			<ScrollView style={styles.content}>
				<View>
					...
					<Text style={styles.controlTitle}>Tema</Text>
					<View style={styles.controlThemeOptions}>
						<SettingsIconBtn
						...
						<SettingsIconBtn
							...
							icon={
								<>
									...
									/>
									<Path
										d="M17 10a7 7 0 00-7-7v14a7 7 0 007-7z"
										fill={'currentColor'}
									/>
								</>
							}
